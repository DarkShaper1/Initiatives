...
class TheChampFollowWidget extends WP_Widget { 
	...
	private function follow_icons( $instance ) {
		...
		if ( $instance['parler'] ) {
			$html .= '<li class="theChampSharingRound"><i style="'. $iconStyle .'" alt="Parler" title="Parler" class="theChampSharing theChampParlerBackground"><a target="_blank" aria-label="Parler" href="'. $instance['parler'] .'" rel="noopener"><ss style="display:block" class="theChampSharingSvg theChampParlerSvg"></ss></a></i></li>';
		}
