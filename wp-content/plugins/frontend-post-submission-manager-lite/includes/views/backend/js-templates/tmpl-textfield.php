<div class="fpsml-each-form-field">
    <div class="fpsml-field-head fpsml-clearfix">
        <h3 class="fpsml-field-title"><span class="dashicons dashicons-arrow-down"></span>{{data.label}} <span class="fpsml-field-type-label">- <?php esc_html_e('Textfield', 'frontend-post-submission-manager-lite'); ?></span></h3>
